...
public class Icons {
    public static final Icon FILE = IconLoader.getIcon("/icons/icon_small.png");
    // TODO: better colors for the next two?
    public static final Icon MOB_FILE = IconLoader.getIcon("/icons/mobTest.svg");
    public static final Icon SCRIPT_FILE = IconLoader.getIcon("/icons/scriptTest.svg");
